...
This code is used to replicate some of the results in the paper.

The structure of Ising triangular lattice generated using the file:

/planar_ising/generate_lattice_plot.py

The collapse plot including critical point and critical exponent generated by the file:

/planar_ising/generate_collapse_plot.py

The error analysis plot is generated by the file:

/planar_ising/generate_precision_plot.py
